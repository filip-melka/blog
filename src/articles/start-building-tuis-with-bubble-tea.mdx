...
<Interactive
  fallback="./fallbacks/elm-architecture-diagram.png"
  caption="The Elm Architecture loop: the View renders the Model, user input and other events become Messages, and Update folds each Message into a new Model."
>
