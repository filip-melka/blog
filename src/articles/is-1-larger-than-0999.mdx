...
<Interactive fallbackText="$8 = 8$">
  <ComparisonReveal client:visible left="8" right="8" sign="=" />
</Interactive>

<Interactive fallbackText="$2 > 1$">
...
<Interactive fallbackText="$0.999\dots = 1$">
...
<Interactive
  fallback="./fallbacks/zeno-paradox.png"
  caption="Four successive steps toward the cup, each one halving the distance that remains: 1/2 m, then 1/4 m, then 1/8 m, then 1/16 m. Try the interactive version on the original post."
>
